...
export const initialRuleViolations: RuleViolation[] = [
  ...
  },
  {
    ...
    severity: 'WARNING',
    description: 'Firm commission of $350.00 has been held in trust for 54 days, exceeding the 14-day transfer deadline under LCA 2006 s110 / Reg 8.',
...
export const complianceWorkflows = [
  ...
  },
  {
    ...
    action: 'A signed PDF evidence pack is produced, satisfying LCA Reg 17 monthly reconciliation requirements. Ready for statutory auditor delivery.'
  },
  {
    phase: 'Annual',
